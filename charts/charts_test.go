...
func TestCharts(t *testing.T) {
	tests := []struct {
		...
		{
			name:         "svg-basic",
			outputPath:   path.Join("testdata", "svg-basic-output.svg"),
			expectedPath: path.Join("testdata", "svg-basic-expected.svg"),
			conf: charts.HeatmapConfig{
				Counts:              loadData(t, path.Join("testdata", "basic.json")),
				ColorScale:          loadColorscale(t, path.Join("..", "assets", "colorscales", "purple-blue-9.csv")),
				DrawMonthSeparator:  true,
		...
		{
			name:         "svg-no-separator",
			outputPath:   path.Join("testdata", "svg-no-separator-output.svg"),
			expectedPath: path.Join("testdata", "svg-no-separator-expected.svg"),
			conf: charts.HeatmapConfig{
				Counts:              loadData(t, path.Join("testdata", "basic.json")),
				ColorScale:          loadColorscale(t, path.Join("..", "assets", "colorscales", "purple-blue-9.csv")),
		...
		{
			name:         "svg-no-labels-no-separator",
			outputPath:   path.Join("testdata", "svg-no-labels-no-separator-output.svg"),
			expectedPath: path.Join("testdata", "svg-no-labels-no-separator-expected.svg"),
			conf: charts.HeatmapConfig{
				Counts:              loadData(t, path.Join("testdata", "basic.json")),
				ColorScale:          loadColorscale(t, path.Join("..", "assets", "colorscales", "purple-blue-9.csv")),
				DrawMonthSeparator:  false,
